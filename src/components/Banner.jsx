...
const Banner = () => {
  ...
  return (
    ...
    >
      ...
      {/* Scroll indicator */}
      <div
        className="absolute bottom-8 w-full flex flex-col items-center gap-2 z-20 pointer-events-none"
        style={{
          opacity: isMounted && !isFullyRevealed ? 1 : 0,
          transition: 'opacity 0.6s ease-in-out',
          animation: revealProgress === 0 && isMounted ? 'scrollFadeIn 2s ease-out forwards' : 'none',
        }}
      >
        <span
          className="text-white text-xs tracking-widest uppercase"
          style={{ textShadow: '0 1px 8px rgba(0,0,0,0.6)', letterSpacing: '0.2em' }}
        >
          Scroll
        </span>
        {/* Mouse shell */}
